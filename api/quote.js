...
export default async function handler(req, res) {
  ...
  try {
      ...
      <body>
        <div class="email-container">
          ...
          <div class="email-footer">
            <p>This quote was generated from the Fun Snaps Photo Booth Rental quote tool.</p>
    ...
    const customerEmailContent = `
      ...
      <body>
        <div class="email-container">
          ...
          <p>Thank you for requesting a quote from Fun Snaps Photo Booth Rental! Below are the details of your quote:</p>
    ...
    const customerEmail = await resend.emails.send({
      from: 'Fun Snaps Photo Booth <info@funsnaps.ca>',
      to: [contact.email],
      subject: `Your Photo Booth Quote from Fun Snaps`,
